    ...
    <footer className="border-t border-border bg-foreground text-background">
      <Container as="div">
        <div className="py-12 md:py-16">
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="mt-4 text-sm text-white/80 max-w-xs">
                Fresh halal shawarma, wraps, platters, and more in Grayson. Family-owned, made to order.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                {navLinks.map(({ href, label }) => (
                  <li key={href}>
                    <Link href={href} className="text-sm text-white/80 hover:text-primary transition-colors">
                      {label}
                    </Link>
                  </li>
                ))}
            ...
            {/* Hours */}
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider text-white/90">Hours</h3>
            ...
            <div>
              ...
              <address className="mt-4 not-italic text-sm text-white/80 space-y-2">
                <p>{SITE.address}</p>
                <p>
          ...
          <div className="mt-10 pt-8 border-t border-white/20 flex flex-col sm:flex-row justify-between items-center gap-4">
